...
# Codigo final del proyecto 2 que consistia en modelar un objeto y usar land marks para mover la camara
# Yo modele una rana encima de un nenufar los cuales rotan 360 grados , ademas de generar hongos y cesped aleatorio y una fuente de iluminacion dinamica que es el sol
# tambien utilice texturas e iluminacion para mejorar la escena
...
def crear_display_list_pasto():
    ...
    draw_grass_blade_triple(0, 0, 1.5, 0.1, 0.1) 
    glEndList()
    return lista
