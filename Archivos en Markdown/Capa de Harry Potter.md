# Capa de Harry Potter.py

Este script crea un efecto de "capa de invisibilidad" en tiempo real usando OpenCV.
Detecta objetos rojos en la imagen de la cámara y los reemplaza por el fondo capturado previamente.
