# landmarks no normalizado para trabajos.py

Detecta la mano usando MediaPipe y reconoce algunas letras del alfabeto de señas basándose en la posición relativa de los dedos,
mostrando en tiempo real los puntos clave, distancias y la letra detectada sobre el video capturado con OpenCV, esta es la version sin normalizar .
