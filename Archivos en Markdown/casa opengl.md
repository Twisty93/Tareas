...
Este script utiliza OpenGL y GLFW para renderizar una sencilla escena 3D con una casa.
La casa está compuesta por un cubo como base y una pirámide como techo, situada sobre un plano que representa el suelo.
