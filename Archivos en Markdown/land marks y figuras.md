# land marks y figuras.py

Controla una cámara 3D en OpenGL usando los movimientos de la mano detectados con MediaPipe y captura de video con OpenCV,
mostrando una escena simple con un árbol y el suelo, y una ventana con la imagen de la webcam.
